...
sudo ln -sf ${LETSENCRYPT_DIR}/live/${MAIN_SITE}/fullchain.pem ${NGINX_SSL_DIR}/default.crt
sudo ln -sf ${LETSENCRYPT_DIR}/live/${MAIN_SITE}/privkey.pem ${NGINX_SSL_DIR}/default.key

while read -r LINE; do
    sudo ln -sf ${LETSENCRYPT_DIR}/live/${MAIN_SITE}/fullchain.pem ${NGINX_SSL_DIR}/${LINE}.crt
    sudo ln -sf ${LETSENCRYPT_DIR}/live/${MAIN_SITE}/privkey.pem ${NGINX_SSL_DIR}/${LINE}.key
done <<< "$SITE_LIST"
