...
task :check_consistency_between_aws_and_carrenza do
  ...
  AWS_ONLY_KEYS = %w[
    ...
    govuk_jenkins::jobs::content_data_api::rake_etl_main_process_cron_schedule
    govuk_jenkins::jobs::content_data_api_re_run::re_run_rake_etl_main_process_cron_schedule
