...
describe 'kibana2_url' do
  ...
  it 'should convert a hash to a URL with base64' do
    ...
    res.should == 'https://kibana.example.com/#eyJmaWVsZHMiOltdLCJvZmZzZXQiOjAsInNlYXJjaCI6IkB0YWdzOnR1c2tzIEFORCBAZmllbGRzLnByaWNrbGVzOlwicHVycGxlXCIiLCJ0aW1lZnJhbWUiOiI4NjQwMCIsImdyYXBobW9kZSI6ImNvdW50In0='
  ...
  it 'should add default search param(s)' do
    ...
    res = scope.function_kibana2_url([base_url, in_hash])
    res.should == 'https://kibana.example.com/#eyJmaWVsZHMiOltdLCJvZmZzZXQiOjAsInNlYXJjaCI6IkB0YWdzOmNsYXdzIEFORCBAZmllbGRzLmV5ZXM6XCJvcmFuZ2VcIiJ9'
