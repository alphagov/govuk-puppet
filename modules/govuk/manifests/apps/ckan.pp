...
class govuk::apps::ckan (
  ...
  $fetch_process_regex = '\/python \.\/venv3\/bin\/ckan -c \/var\/ckan\/ckan\.ini harvester fetch-consumer'
  $gather_process_regex = '\/python \.\/venv3\/bin\/ckan -c \/var\/ckan\/ckan\.ini harvester gather-consumer'
