# == Class: govuk_node::s_content_publisher_db_admin
#
# This machine class is used to administer the Content Publisher
...
#   Default: '5432'
#
class govuk::node::s_content_publisher_db_admin(
  $postgres_host        = undef,
  $postgres_user        = undef,
