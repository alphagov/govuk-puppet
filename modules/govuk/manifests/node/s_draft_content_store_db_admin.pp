# == Class: govuk_node::s_content_store_db_admin
#
# This machine class is used to administer the Draft Content Store
...
#   Default: '5432'
#
class govuk::node::s_draft_content_store_db_admin(
  $postgres_host        = undef,
  $postgres_user        = undef,
