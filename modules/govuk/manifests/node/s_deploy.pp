...
class govuk::node::s_deploy (
  ...
  class { 'govuk_jenkins':
    ...
    plugins               => {},
    version               => '2.19.2',              #FIXME Remove this line once deploys are fully migrated to Jenkins 2
  }
  ...
  nginx::config::site { 'jenkins':
    content => template('govuk/node/s_deploy/jenkins.conf.erb'),
