# == Class: govuk_node::s_local_links_manager_db_admin
#
# This machine class is used to administer the Local Links Manager
...
#   Default: '5432'
#
class govuk::node::s_local_links_manager_db_admin(
  $postgres_host        = undef,
  $postgres_user        = undef,
