# == Class: govuk_node::s_authenticating_proxy_db_admin
#
# This machine class is used to administer the Authenticating Proxy
...
#   Default: '5432'
#
class govuk::node::s_authenticating_proxy_db_admin(
  $postgres_host        = undef,
  $postgres_user        = undef,
