# == Class: govuk_node::s_service_manual_publisher_db_admin
#
# This machine class is used to administer the Service Manual Publisher
...
#   Default: '5432'
#
class govuk::node::s_service_manual_publisher_db_admin(
  $postgres_host        = undef,
  $postgres_user        = undef,
