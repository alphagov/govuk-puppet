class users::groups::other {
  ...
  govuk::user { 'tomstuart':
    ...
    ssh_key  => '',
  }

  govuk::user { 'chrismdp':
    fullname => 'Chris Parsons',
    email    => 'chris@thinkcodelearn.com',
    ssh_key  => '',
  }
