...
describe 'haproxy::balance_ssl', :type => :define do
  context 'external load balancer' do
    ...
    it 'should create haproxy fragment listening on 8080' do
      ...
      should contain_concat__fragment('haproxy_listen_giraffe').
    ...
    it 'should create nginx proxy allowing everyone access' do
      ...
      should contain_nginx__config__site('giraffe.dev.gov.uk')
      should_not contain_nginx__config__site('giraffe.dev.gov.uk').with_content(/deny all/)
    end
  end
