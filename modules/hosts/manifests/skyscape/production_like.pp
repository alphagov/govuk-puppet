class hosts::skyscape::production_like ($platform = $::govuk_platform) {
  ...
  host { "mongo-1.backend.${platform}"           : ip => "10.3.0.6", host_aliases =>  ["mongo-1",
                                                                                      "mongo.backend.${platform}",
                                                                                      "mongodb.cluster"
                                                                                      ]}
  ...
  host { "elms-backend-1.backend.${platform}"    : ip => "10.3.5.0", host_aliases =>  ["elms-backend-1",
